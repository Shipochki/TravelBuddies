    ...
    <div className="profile-main">
      ...
      <div className="profile-content">
        ...
        <div className="profile-reviews">
          <h4>Reviews</h4>
          {user.id != localStorage.userId && <CreateReview user={user} />}
          {user.reviews && user.reviews.length ? (
            ...
            <div>User don't have any reviews</div>
          )}
          {user.reviews && user.reviews.length == 3 && (
            <div>
              <Link
                className="load-more-reviews"
                to={`/reviews?reciverId=${user.id}&page=1&pageCount=10`}
              >
                Load more
              </Link>
            </div>
