...
export const Message = ({ message, i, ownerId }) => {
  ...
  return (
    <div
      ...
      id={i}
      className={`message ${
        message.creatorId == localStorage.userId && "my-message"
      }`}
    >
      <div className="message-content">
            ...
            <div>
              {message.creatorId == localStorage.userId && (
                <div className="message-edit-menu">
                  <button
                    className="message-buttons-edit"
                    onClick={() => {
              ...
              <button
                ...
                className="message-buttons-delete"
              >
        ...
        <div>
          {message.creatorId != localStorage.userId && (
            <p className="message-creator-name">{message.creatorName}</p>
          )}
